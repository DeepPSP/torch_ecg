...
from torch_ecg.utils.outputs import MultiLableClassificationOutput, SequenceLabelingOutput
...
class ECG_CRNN_CPSC2020(ECG_CRNN):
    ...
    def inference(self,
                  ...
                  bin_pred_thr:float=0.5) -> MultiLableClassificationOutput:
        """ finished, checked,
...
class ECG_SEQ_LAB_NET_CPSC2020(ECG_SEQ_LAB_NET):
    ...
    def inference(self,
                  ...
                  rpeak_inds:Optional[List[np.ndarray]]=None) -> SequenceLabelingOutput:
        """ finished, checked,
        ...
        return SequenceLabelingOutput(
            ...
            SPB_indices=SPB_indices, PVC_indices=PVC_indices,
        )

    @torch.no_grad()
    def inference_CPSC2020(self,
                           input:Union[np.ndarray,Tensor],
                           bin_pred_thr:float=0.5) -> SequenceLabelingOutput:
        """
        alias for `self.inference`
        """
