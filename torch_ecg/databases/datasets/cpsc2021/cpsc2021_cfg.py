...
CPSC2021TrainCfg.betas = (0.9, 0.999)  # default values for corresponding PyTorch optimizers
...
CPSC2021TrainCfg.qrs_detection.classes = ["N",]
...
CPSC2021TrainCfg.rr_lstm.classes = ["af",]
...
CPSC2021TrainCfg.main.classes = ["af",]
