...
class CINC2021(PhysioNetDataBase):
    ...
    def get_fs(self, rec: Union[str, int], from_hea: bool = True) -> Union[int, float]:
...
def _compute_beta_measures(labels: NDArray, outputs: NDArray, beta: Union[int, float]) -> Tuple[float, float]:
